        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div class="lg:col-span-3">
                ...
                <nav class="flex mb-6 text-sm text-slate-500">
                    ...
                    <a href="{{ route('public.gallery.videos') }}" class="hover:text-primary">Galeri Video</a>
                    <span class="mx-2">/</span>
                ...
                <div class="mb-8 aspect-video bg-black flex items-center justify-center rounded shadow overflow-hidden relative">
                    <iframe class="w-full h-full" src="{{ $gallery->video_url }}" title="{{ $gallery->title }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                ...
                <div class="mt-8 pt-8 border-t border-slate-200">
                    <h4 class="font-bold text-sm mb-4 uppercase">Bagikan Video Ini</h4>
