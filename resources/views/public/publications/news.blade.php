            ...
            <div class="lg:col-span-3">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white dark:bg-slate-800">
                        <a href="{{ route('public.publications.news.show', $item->slug) }}" class="block text-primary hover:underline text-lg font-bold mb-4">
                            {{ $item->title }}
                        </a>
                        ...
                        <div class="flex justify-between items-center mt-2 pt-2 border-t border-dotted border-slate-300">
                            ...
                            <a href="{{ route('public.publications.news.show', $item->slug) }}" class="text-xs px-3 py-1 border border-slate-300 text-slate-600 hover:bg-slate-100 transition rounded-sm">Baca</a>
                        </div>
                    </div>
                    @endforeach
